...
class Screen(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"党员管理系统", pos=wx.DefaultPosition, size=wx.Size(800, 600),
        ...
        self.btn_info = wx.Button(self.left_panel, wx.ID_ANY, u"党员信息", wx.DefaultPosition, wx.DefaultSize, 0)
        leftSizer.Add(self.btn_info, 0, wx.EXPAND | wx.TOP | wx.RIGHT | wx.LEFT, 5)

        self.btn_io = wx.Button(self.left_panel, wx.ID_ANY, u"转入转出", wx.DefaultPosition, wx.DefaultSize, 0)
        leftSizer.Add(self.btn_io, 0, wx.EXPAND | wx.TOP | wx.RIGHT | wx.LEFT, 5)

        self.btn_df = wx.Button(self.left_panel, wx.ID_ANY, u"党费收缴", wx.DefaultPosition, wx.DefaultSize, 0)
        leftSizer.Add(self.btn_df, 0, wx.TOP | wx.RIGHT | wx.LEFT | wx.EXPAND, 5)

        self.btn_print = wx.Button(self.left_panel, wx.ID_ANY, u"信息导出", wx.DefaultPosition, wx.DefaultSize, 0)
        ...
        hSizer.Add(self.left_panel, 1, wx.EXPAND | wx.ALL, 0)

        self.m_auinotebook1 = wx.aui.AuiNotebook(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize,
                                                 wx.aui.AUI_NB_DEFAULT_STYLE)

        hSizer.Add(self.m_auinotebook1, 4, wx.EXPAND | wx.ALL, 0)

        self.p_info = ui.panels.Panel_info(self.m_auinotebook1)
        self.m_auinotebook1.AddPage(self.p_info,'党员信息',False,wx.NullBitmap)
